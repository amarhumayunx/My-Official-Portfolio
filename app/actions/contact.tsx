...
export async function sendMultiStepContactMessage(formData: FormData) {
  ...
  try {
    ...
    // Create comprehensive email content with enhanced landscape mode support
    const emailContent = `
      <!DOCTYPE html>
      <html lang="en">
      <head>
        ...
        <style>
          ...
          /* Mobile Landscape Styles - Key Enhancement */
          @media (max-width: 900px) and (orientation: landscape) {
            ...
            /* Enhanced grid for landscape - can show 2 columns */
            .info-grid {
          ...
          @media (min-width: 601px) and (max-width: 1024px) and (orientation: landscape) {
            ...
            /* Optimal grid for tablet landscape */
            .info-grid {
          ...
          @media (max-width: 480px) and (orientation: landscape) {
            ...
            .info-grid {
              gap: 8px;
              /* Force single column on very small landscape screens */
              grid-template-columns: 1fr;
            }
            .badge {
              font-size: 11px;
          ...
          /* Large Mobile Landscape (phablets) */
          @media (min-width: 481px) and (max-width: 600px) and (orientation: landscape) {
            .info-grid {
              /* Allow 2 columns on larger landscape phones */
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>From ${data.name} • ${new Date().toLocaleDateString()}</p>
          </div>
          ...
          <div class="section">
            ...
            <div class="info-grid">
              <div class="info-item">
                ...
                <div class="info-value">${projectTypeMap[data.projectType] || data.projectType}</div>
              </div>
              <div class="info-item">
                <div class="info-label">Budget Range</div>
                <div class="info-value">${budgetMap[data.budget] || data.budget}</div>
              </div>
              <div class="info-item">
                <div class="info-label">Timeline</div>
                <div class="info-value">${timelineMap[data.timeline] || data.timeline}</div>
              </div>
            </div>
          ...
          <div class="section">
            ...
            <div class="badge-container">
              ${technologies.map((tech: string) => `<span class="badge badge-tech">${tech}</span>`).join("")}
            </div>
            `
                : ""
            }
            ...
            <div class="badge-container">
              ${features.map((feature: string) => `<span class="badge">${feature}</span>`).join("")}
            </div>
            `
                : ""
            }
          ...
          <div class="section">
            ...
            <div class="file-list">
              ...
              <div class="file-item">
                <div>
                  ...
                  <small style="color: #6b7280;">${(file.size / 1024 / 1024).toFixed(2)} MB • ${file.type}</small>
                </div>
              </div>
              `,
                )
            ...
            <div class="info-grid" style="margin-top: 20px;">
              ...
              <div class="info-item">
                ...
                <div class="info-value">${contactMap[data.preferredContact] || data.preferredContact}</div>
              </div>
              `
                  : ""
              }
              ...
              <div class="info-item ${data.urgency === "urgent" ? "priority-urgent" : data.urgency === "high" ? "priority-high" : ""}">
                ...
                <div class="info-value">${urgencyMap[data.urgency] || data.urgency}</div>
              </div>
              `
                  : ""
              }
              ...
              <div class="info-item">
                ...
                <div class="info-value">${hearAboutMap[data.hearAbout] || data.hearAbout}</div>
              </div>
              `
                  : ""
              }
